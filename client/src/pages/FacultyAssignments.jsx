                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              {sub.completed ? (
                                <div style={{ fontSize: "0.85rem", marginTop: "4px" }}>
                                  ...
                                  {sub.submissionFile && <p style={{ margin: "4px 0 0" }}>File submitted: {sub.submissionFile.name} · <button type="button" className="link-button" onClick={() => downloadToFile(`/shared/student/assignments/${a.id}/submission/file?studentId=${sub.id}`, sub.submissionFile.name)}>Download</button></p>}
