...
// Canonical CSV cell escaper for every attendance export (staff export.csv and
// the admin reports.csv share this). Beyond quote-doubling, prefixes a
// leading `'` when the cell's string form starts with `=`, `+`, `-`, `@`,
// tab, or CR — the standard mitigation against formula injection in
// Excel/Sheets — so any free-text field (names, reasons, remarks, etc.)
// can't be used to smuggle a formula into the exported file.
export { csvEscape } from "./csv.js";
